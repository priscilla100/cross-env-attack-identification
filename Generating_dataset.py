...
if __name__ == '__main__':
    ...
    pcapfiles = [
#     'dos-synflooding-6-dec.pcap',
# 'DoS-SYN_Flood7.pcap',
# 'dos-synflooding-1-dec.pcap',
# 'dos-synflooding-2-dec.pcap',
# 'dos-synflooding-3-dec.pcap',
# 'mirai-udpflooding-4-dec.pcap',
# 'mirai-udpflooding-1-dec.pcap',
